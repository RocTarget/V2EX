...
open class LoadingButton: UIButton {
    ...
    open var hideImageWhenLoading: Bool = false {
        didSet {
            configureControl(for: currentControlState())
        }
    }
    ...
    open func setActivityIndicatorAlignment(_ alignment: ActivityIndicatorAlignment) {
    ...
    func setupActivityIndicator() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(LoadingButton.activityIndicatorTapped(_:)))
...
//    
//    public var indicatorAlignment:ActivityIndicatorAlignment = .Left {
//        didSet {
...
//                                 attribute: .trailingMargin, multiplier: 0.85,
//                                 constant: 0)
//        }
//        
